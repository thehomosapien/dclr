...
find ${DISTNAME}/bin -type f -executable -exec ../dclrcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../dclrcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/dclrcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/dclrcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz

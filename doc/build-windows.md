...
Below are some notes on how to build DCLRcoin Core for Windows.
...
Building on Ubuntu Xenial 16.04 is known to be broken, see extensive discussion in issue [8732](https://github.com/DCLRProject/DCLRcoin/issues/8732).
...
to work around issues with mingw-w64. See issue [8732](https://github.com/DCLRProject/DCLRcoin/issues/8732) for more information.
```
...
way. This will install to `c:\workspace\dclr`, for example:

    make install DESTDIR=/mnt/c/workspace/dclr

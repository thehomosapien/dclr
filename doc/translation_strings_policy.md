...
This document provides guidelines for internationalization of the DCLRcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `dclr_en.ts` remains unchanged.

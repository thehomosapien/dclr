DCLRcoin Core version *2.2.2* is now available!!
==============

  <https://github.com/DCLRProject/DCLRcoin/releases/tag/v2.2.2>
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/DCLRProject/DCLRcoin/issues>

To receive security and update notifications, please subscribe to:

  <https://dclrcoin.org/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/DCLR-Qt` (on Mac)
or `dclrd`/`dclr-qt` (on Linux).
...
DCLRcoin Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows 10(x64) and later. 32-bit versions of Windows,
and Windows XP are not supported.

DCLRcoin Core should also work on most other Unix-like systems but is not
frequently tested on them.

DCLRcoin Core has been tested with macOS 10.14 Mojave, but it is recommended that *developers*
...
- Enhancements for DCLRcoin Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/DCLRProject/DCLRcoin/commits/release_2.2.2>
...
- Most importantly - The DCLR Community!
- Tron Black
- Jesse Empey
- Jeremy Anderson
- Corbin Fox

...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DCLRTestFramework
    pass

class ExampleTest(DCLRTestFramework):
    # Each functional test is a subclass of the DCLRTestFramework class.
    ...
    def custom_method(self):
        ...
        DCLRTestFramework class so other tests can use it."""

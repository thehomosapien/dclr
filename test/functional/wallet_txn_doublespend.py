...
class TxnMallTest(DCLRTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 DCLR:
        ...
        # First: use raw transaction API to send 1240 DCLR to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 DCLR coin each
        ...
        # Node0's balance should be starting balance, plus 50DCLR for another
        ...
        # Node0's total balance should be starting balance, plus 100DCLR for 

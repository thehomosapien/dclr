...
By default, dclrd will dump mempool on shutdown and
...
class MempoolPersistTest(DCLRTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give dclrd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent dclrd from writing mempool.dat to disk. Verify that `savemempool` fails")

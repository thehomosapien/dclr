...
from test_framework.test_framework import DCLRTestFramework, SkipTest
...
class ZMQTest (DCLRTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that dclr has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("dclrd has not been built with zmq enabled.")

...
from test_framework.test_framework import DCLRTestFramework
from test_framework.util import *
from test_framework.blocktools import create_block, create_coinbase, add_witness_commitment
from test_framework.script import CScript, OP_TRUE

# TestNode: A peer we use to send messages to dclrd, and store responses.
...
class CompactBlocksTest(DCLRTestFramework):
    ...
    # This test actually causes dclrd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that dclrd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for dclrd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # dclrd will not send blocktxn responses for blocks whose height is

...
class BIP66Test(DCLRTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # dclrd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and dclrd produces more specific reject
            # reasons.

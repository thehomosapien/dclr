...
class AssetTest(DCLRTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating DCLR for node[0] and activating assets...")
    ...
    def big_test(self):
        ...
        n0.listassets(asset="DCLR*", verbose=False, count=2, start=-2)
        ...
        dclr_assets = n0.listassets(asset="DCLR*", verbose=False, count=2, start=-2)
        assert_equal(len(dclr_assets), 2)
        assert_equal(dclr_assets[0], "DCLR2")
        assert_equal(dclr_assets[1], "DCLR3")
        self.sync_all()

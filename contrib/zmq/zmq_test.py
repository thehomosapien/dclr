...
"""
    ...
    DCLR should be started with the command line arguments:
        dclrd -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND DCLR issuance at " + str(pos))
				print("After DCLR: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND DCLR something at " + str(pos))
			start += pos+8
			print(astr)

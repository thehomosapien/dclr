...
#ifndef DCLR_QT_DCLRGUI_H
#define DCLR_QT_DCLRGUI_H
...
/**
  DCLR GUI main class. This class represents the main window of the DCLR UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DCLRGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DCLRGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~DCLRGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a dclr wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */

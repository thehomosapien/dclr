...
#include "config/dclr-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatDCLRURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + DCLRUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatDCLRURI(info));
}

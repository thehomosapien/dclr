    ...
    platformStyle(_platformStyle)
{
    ...
    this->setStyleSheet(QString(".SendCoinsEntry {background-color: %1; padding-top: 10px; padding-right: 30px; border-radius: 20px; border: 3px solid #2ed7a3;}").arg(platformStyle->SendEntriesBackGroundColor().name()));
    ...
    ui->payAmount->setFont(GUIUtil::getSubLabelFontBolded());

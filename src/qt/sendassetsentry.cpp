    ...
    platformStyle(_platformStyle)
{
    ...
    // normal dclr address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying dclr address(es)
    ...
    ui->messageLabel->setFont(GUIUtil::getSubLabelFontBolded());
    ...
    ui->assetSelectionBox->setFont(GUIUtil::getSubLabelFontBolded());
    ui->administratorCheckbox->setFont(GUIUtil::getSubLabelFontBolded());
    ui->payTo->setFont(GUIUtil::getSubLabelFontBolded());
    ui->addAsLabel->setFont(GUIUtil::getSubLabelFontBolded());
    ui->payAssetAmount->setFont(GUIUtil::getSubLabelFontBolded());
    ui->messageTextLabel->setFont(GUIUtil::getSubLabelFontBolded());
    ui->assetAmountLabel->setFont(GUIUtil::getSubLabelFontBolded());
    ui->ownershipWarningMessage->setFont(GUIUtil::getSubLabelFontBolded());
}

...
//    connect(bumpFeeAction, SIGNAL(triggered()), this, SLOT(bumpFee()));
    ...
    dateWidget->setFont(GUIUtil::getSubLabelFontBolded());
    typeWidget->setFont(GUIUtil::getSubLabelFontBolded());
    addressWidget->setFont(GUIUtil::getSubLabelFontBolded());
    amountWidget->setFont(GUIUtil::getSubLabelFontBolded());
    assetNameWidget->setFont(GUIUtil::getSubLabelFontBolded());
    contextMenu->setFont(GUIUtil::getSubLabelFontBolded());
    transactionView->setFont(GUIUtil::getSubLabelFontBolded());
...
void TransactionView::changedAmount()
{
    ...
    if (DCLRUnits::parse(model->getOptionsModel()->getDisplayUnit(), amountWidget->text(), &amount_parsed)) {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(DCLRUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);

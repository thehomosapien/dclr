...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(DCLRUnits::DCLR),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setFont(GUIUtil::getSubLabelFontBolded());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(DCLRUnits::formatWithUnit(unit, balance, false, DCLRUnits::separatorAlways));
    ui->labelUnconfirmed->setText(DCLRUnits::formatWithUnit(unit, unconfirmedBalance, false, DCLRUnits::separatorAlways));
    ui->labelImmature->setText(DCLRUnits::formatWithUnit(unit, immatureBalance, false, DCLRUnits::separatorAlways));
    ui->labelTotal->setText(DCLRUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, DCLRUnits::separatorAlways));
    ui->labelWatchAvailable->setText(DCLRUnits::formatWithUnit(unit, watchOnlyBalance, false, DCLRUnits::separatorAlways));
    ui->labelWatchPending->setText(DCLRUnits::formatWithUnit(unit, watchUnconfBalance, false, DCLRUnits::separatorAlways));
    ui->labelWatchImmature->setText(DCLRUnits::formatWithUnit(unit, watchImmatureBalance, false, DCLRUnits::separatorAlways));
    ui->labelWatchTotal->setText(DCLRUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, DCLRUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("DCLR")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the DCLR balance grid from expanding and looking terrible when asset balance is hidden

...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<DCLRAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_dclr-qt -platform xcb      # Linux
//     src/qt/test/test_dclr-qt -platform windows  # Windows
//     src/qt/test/test_dclr-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = DCLRUnits::formatWithUnit(unit, balance, false, DCLRUnits::separatorAlways);
    ...
    // Amount input
    DCLRAmountField* amountInput = receiveCoinsDialog.findChild<DCLRAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: dclr:")) != -1);

...
#ifndef DCLR_QT_GUIUTIL_H
#define DCLR_QT_GUIUTIL_H
...
/** Utility functions used by the DCLR Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "dclr:" URI into recipient object, return true on successful parsing

...
#ifndef DCLR_QT_GUICONSTANTS_H
#define DCLR_QT_GUICONSTANTS_H
...
/* DCLRGUI -- Size of icons in status bar */
...
#define COLOR_WHITE QColor("#f1f5f9")
...
/* DCLRcoin dark orange */
#define COLOR_DARK_ORANGE QColor("#03161c")
/* DCLRcoin light orange */
#define COLOR_LIGHT_ORANGE QColor("#02121d")
/* DCLRcoin dark blue */
#define COLOR_DARK_BLUE QColor("#2fd7a4")
/* DCLRcoin light blue */
#define COLOR_LIGHT_BLUE QColor("#209a7c")
/* DCLRcoin asset text */
#define COLOR_ASSET_TEXT QColor(255, 255, 255)
/* DCLRcoin shadow color - light mode */
...
/* DCLRcoin label color as a string */
#define STRING_LABEL_COLOR "color: #00161c"
...
#define QAPP_ORG_NAME "DCLR"
#define QAPP_ORG_DOMAIN "dclr.org"
#define QAPP_APP_NAME_DEFAULT "DCLR-Qt"
#define QAPP_APP_NAME_TESTNET "DCLR-Qt-testnet"

#endif // DCLR_QT_GUICONSTANTS_H

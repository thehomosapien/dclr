...
#ifndef DCLR_QT_DCLRUNITS_H
#define DCLR_QT_DCLRUNITS_H
...
/** DCLR unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DCLRUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DCLRUnits(QObject *parent);

    /** DCLR units.
      @note Source: https://en.dclr.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DCLR,
...
typedef DCLRUnits::Unit DCLRUnit;

#endif // DCLR_QT_DCLRUNITS_H

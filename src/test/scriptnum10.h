...
#ifndef DCLR_TEST_SCRIPTNUM10_H
#define DCLR_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from DCLRcoin Core 0.10.0, for cross-comparison.
 */
public:

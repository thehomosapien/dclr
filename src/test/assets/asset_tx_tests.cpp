...
BOOST_FIXTURE_TEST_SUITE(asset_tx_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_valid_test)
    {
        ...
        CAssetTransfer asset("DCLR", 1000);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_not_valid_test)
    {
        ...
        // This should fail because 900 DCLR doesn't have a destination
        CAssetTransfer assetTransfer("DCLR", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_valid_multiple_outs_test)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            CAssetTransfer asset2("DCLR", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_multiple_assets_test)
    {
        ...
        CAssetTransfer asset2("DCLRTEST", 1000);
        CScript scriptPubKey2 = GetScriptForDestination(DecodeDestination(Params().GlobalBurnAddress()));
        asset2.ConstructTransaction(scriptPubKey2);

        CAssetTransfer asset3("DCLRTESTTEST", 1000);
        ...
        {
            // Add the first asset
            CAssetTransfer outAsset("DCLR", 100);
            ...
            CAssetTransfer outAsset2("DCLRTEST", 100);
            ...
            // Add the third asset
            CAssetTransfer outAsset3("DCLRTESTTEST", 100);
        ...
        // The inputs are spending 3000 Assets (1000 of each DCLR, DCLRTEST, DCLRTESTTEST)
        // The outputs are spending 100 Assets to 10 destinations (10 * 100 = 1000) (of each DCLR, DCLRTEST, DCLRTESTTEST)

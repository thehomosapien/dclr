/* src/config/dclr-config.h.  Generated from dclr-config.h.in by configure.  */
/* src/config/dclr-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DCLR_CONFIG_H

#define DCLR_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The DCLRcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "DCLRcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/DCLRProject/DCLRcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DCLRcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DCLRcoin Core 2.2.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dclr"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://dclrcoin.org/"
